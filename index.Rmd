...
others_to_forest_01 <- select(others_to_forest, 1:2)
names(others_to_forest_01) <- c("LST", "LULC")
others_to_forest_16 <- select(others_to_forest, 3:4)
...
others_to_wetland_01 <- select(others_to_wetland, 1:2)
names(others_to_wetland_01) <- c("LST", "LULC")
others_to_wetland_16 <- select(others_to_wetland, 3:4)
